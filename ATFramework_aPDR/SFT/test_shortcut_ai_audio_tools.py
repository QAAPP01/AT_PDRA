...
class Test_Shortcut_AI_Audio_Tools:
    ...
    @allure.story("Speech Enhance")
    @allure.title("Media Picker")
    @allure.step("Back from media picker")
    ...
    @allure.story("Speech Enhance")
    @allure.title("Editor")
    @allure.step("Play start position")
