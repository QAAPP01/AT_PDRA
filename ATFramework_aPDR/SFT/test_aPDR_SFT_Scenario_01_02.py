...
class Test_SFT_Scenario_01_02:
    ...
    def test_sce_01_02_02(self):
        ...
        self.report.new_result(udid[0], page_media.check_element_not_exists(L.import_media.photo_library.sort))
        # enter folder > PDRa_Testing_Material
        self.report.start_uuid(udid[1])
        page_media.select_media_by_text(self.test_material_folder)
        self.report.new_result(udid[1], page_media.check_element_exists(L.import_media.photo_library.sort))
        # check default sorting is by date and descending
        self.report.start_uuid(udid[2])
        page_media.click(L.import_media.photo_library.sort)
        if page_media.is_element_checked(L.import_media.photo_library.sort_menu.by_date):
            if page_media.is_element_checked(L.import_media.photo_library.sort_menu.descending):
    ...
    def test_sce_01_02_04(self):
        ...
        self.report.new_result(udid[8], page_media.is_not_exist(L.import_media.photo_library.sort_menu.by_duration))
        # case 1: (Ascending) By Name
        self.report.start_uuid(udid[0])
        page_media.click(L.import_media.photo_library.sort_menu.by_name)
        page_media.click(L.import_media.photo_library.sort_menu.ascending)
        ...
        self.report.start_uuid(udid[2])
        page_media.click(L.import_media.photo_library.sort)
        page_media.click(L.import_media.photo_library.sort_menu.by_resolution)
        page_media.driver.driver.back()
        ...
        page_media.click(L.import_media.photo_library.sort)
        page_media.click(L.import_media.photo_library.sort_menu.by_filesize)
        page_media.driver.driver.back()
