...
def module_setup(shortcut, driver):
    ...
    page_main, page_edit, page_media, page_preference, *_ = shortcut
...
class TestMasterVideoAdjustment_AIColor:
...
class TestMasterVideoAdjustment_Brightness:
...
class TestMasterVideoAdjustment_Contrast:
...
class TestMasterVideoAdjustment_Saturation:
...
class TestMasterVideoAdjustment_HSL:
...
class TestMasterVideoAdjustment_Hue:
...
class TestMasterVideoAdjustment_Temp:
...
class TestMasterVideoAdjustment_Tint:
...
class TestMasterVideoAdjustment_Sharpness:
