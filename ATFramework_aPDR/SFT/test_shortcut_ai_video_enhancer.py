...
@allure.epic("Shortcut - AI Video Enhancer")
class Test_Shortcut_AI_Video_Enhancer:
    ...
    def test_back_to_ai_creation(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_ai_feature('AI Video Enhancer')
    ...
    def test_back_to_shortcut(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_shortcut('AI Video Enhancer')
    ...
    def test_reset_dont_show_again(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_shortcut('AI Video Enhancer', check=False)
    ...
    def test_back_from_media_picker(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_media_picker('AI Video Enhancer')
