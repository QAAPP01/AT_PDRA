...
@allure.epic("Shortcut - Body Effect")
class Test_Shortcut_Body_Effect:
    ...
    def test_back_from_media_picker(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_media_picker('Body Effect')
    ...
    def test_video_back_from_trim(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_trim_before_edit('Body Effect')
    ...
    def test_video_back_from_editor(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_editor('Body Effect')
    ...
    def test_photo_pause_preview(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_editor('Body Effect', media_type='photo', file=photo_9_16)
