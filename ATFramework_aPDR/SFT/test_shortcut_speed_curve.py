...
@allure.epic("Shortcut - Speed Curve")
class Test_Shortcut_Speed_Curve:
    ...
    def test_back_from_media_picker(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_media_picker('Speed Curve')
    ...
    def test_video_back_from_trim(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_trim_before_edit('Speed Curve')
    ...
    def test_video_back_from_editor(self, data):
        try:
            if self.last_is_fail(data):
                self.page_shortcut.enter_editor('Speed Curve')
