...
class Test_master_Photo_Crop_Rotate:
    ...
    def test_enter_crop_rotate(self, driver):
        ...
        try:
            assert self.page_edit.crop_rotate.start_with_crop_rotate('master photo')
    ...
    def test_crop_9_16(self, driver):
        ...
        try:
            ...
            self.page_edit.crop_rotate.start_with_crop_rotate('master photo')
            raise Exception
