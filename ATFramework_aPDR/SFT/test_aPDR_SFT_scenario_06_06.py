...
class Test_SFT_Scenario_06_06:
    ...
    def test_sce_06_06_01(self):
        ...
        page_edit.settings.swipe_to_option('Default Video Quality')
        result = page_timeline_settings.get_settings_default_video_quality()
        self.report.new_result('60596329-a97c-49d0-8728-054c006d7fd2', True if result == 'Full HD 1080p' else False)
        self.report.new_result('782cbeab-94c0-4429-97b5-e7e0308337fb', True if result == 'Full HD 1080p' else False)
        ...
        time.sleep(3)
        result = True if page_timeline_settings.get_settings_video_quality_radio_is_checked() == 'fhd' else False
