...
class Test_master_Video_Crop_Rotate:
    ...
    def test_enter_crop_rotate(self, driver):
        ...
        try:
            assert self.page_edit.crop_rotate.start_with_crop_rotate('master video')
    ...
    def test_crop_9_16(self, driver):
        ...
        try:
            ...
            self.page_edit.crop_rotate.start_with_crop_rotate('master video')
            raise Exception
    ...
    @allure.title('Play & Pause')
    def test_crop_rotate_play_pause(self, driver):

        try:
            assert self.page_edit.crop_rotate.play_pause()
    ...
    @allure.title('Click Timeline')
    def test_crop_rotate_click_timeline(self, driver):

        try:
            assert self.page_edit.crop_rotate.click_timeline()
