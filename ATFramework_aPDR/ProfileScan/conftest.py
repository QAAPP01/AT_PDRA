...
import main_profile_scan

DRIVER_DESIRED_CAPS = ''
REPORT_INSTANCE = MyReport(tr_number=main_profile_scan.tr_number, previous_tr_number=main_profile_scan.previous_tr_number)
DEFAULT_BROWSER = 'com.android.chrome'
platform_type = 'Android'
PACKAGE_NAME = main_profile_scan.package_name
