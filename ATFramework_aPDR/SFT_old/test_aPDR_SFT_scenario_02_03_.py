...
class Test_SFT_Scenario_02_03:
    ...
    def test_sce_02_03_01(self):
        ...
        time.sleep(2)
        result_check_edit_btn = (True if page_edit.is_exist(L.edit.preview.btn_title_designer_right_top) and
                                       page_edit.is_exist(L.edit.menu.edit) else False)
        ...
        page_edit.title_designer.set_font_face('OFF')
        ...
        pic_base = pic_after
        page_edit.el(L.edit.preview.btn_title_designer_right_top).click()
        page_edit.title_designer.set_font_face('ON')
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        pic_base = pic_after
        page_edit.el(L.edit.preview.btn_title_designer_right_top).click()
        page_edit.el(L.edit.title_designer.color_red).click()
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        pic_base = pic_after
        page_edit.el(L.edit.preview.btn_title_designer_right_top).click()
        page_edit.el(L.edit.title_designer.align_mid).click()
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        pic_base = pic_after
        time.sleep(1)
        page_edit.title_designer.set_border('ON')
        time.sleep(1)
        page_edit.el(L.edit.title_designer.slider_border_size).set_text('8')
        page_edit.driver.driver.back()
        time.sleep(1)
        pic_after = page_edit.get_preview_pic()
        self.report.new_result('96ee8805-cadc-4fdb-b94f-c140b2418ee4',
                               (lambda pic_src, pic_dest: True if not CompareImage(pic_src, pic_dest,
                                                                                   5).compare_image() else False)(
                                   pic_base, pic_after))
        ...
        page_edit.el(L.edit.preview.btn_title_designer_right_top).click()
        page_edit.el(L.edit.title_designer.btn_edit_bolder).click()
        page_edit.title_designer.set_border('OFF')
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        self.report.new_result('baf9362d-289c-4ed0-a422-a3c466bdf078', True if (page_edit.el(L.edit.title_designer.switch_shadow).get_attribute('checked') == 'false') and
                                                                               (page_edit.el(L.edit.title_designer.switch_fill_shadow).get_attribute('enabled') == 'false')
                                else False)
        #Shadow - ON (default: OFF) w/ black color (default)
        self.report.start_uuid('9a732f1a-b296-48cb-b7a4-1832968fd943')
        pic_base = pic_after
        page_edit.title_designer.set_shadow('ON')
        time.sleep(1)
        page_edit.el(L.edit.title_designer.slider_shadow_distance).set_text('8')
        time.sleep(1)
        page_edit.el(L.edit.title_designer.color_pink).click()
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        page_edit.el(L.edit.preview.btn_title_designer_right_top).click()
        page_edit.el(L.edit.title_designer.btn_edit_shadow).click()
        page_edit.title_designer.set_shadow('OFF')
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
        ...
        page_edit.title_designer.set_shadow('ON')
        time.sleep(1)
        page_edit.el(L.edit.title_designer.slider_shadow_distance).set_text('6')
        page_edit.el(L.edit.title_designer.color_red).click()
        page_edit.driver.driver.back()
        pic_after = page_edit.get_preview_pic()
    ...
    def test_sce_02_03_02(self):
        ...
        time.sleep(2)
        result_snap = page_effect.check_effect_snap_to_boundary()
        ...
        self.report.start_uuid('764b5976-11e7-4a8d-ab2c-0be90a3c0469')
        self.report.new_result('764b5976-11e7-4a8d-ab2c-0be90a3c0469', True if default_value == '0' else False)
        self.report.start_uuid('06268258-b261-4f27-b53b-2cc0d8579e08')
        self.report.start_uuid('7cd9cba3-4a5e-43f3-b099-d879e16ebb42')
        pic_base = page_edit.get_preview_pic()
        ...
        self.report.new_result('7cd9cba3-4a5e-43f3-b099-d879e16ebb42', result)
        ...
        page_edit.el(L.edit.color_sub.preset_sub.color_profile_2).click()
        ...
        self.report.start_uuid('c70ea876-1da7-4142-86b7-93b049395471')
        time.sleep(1)
        # ========================
        # [Pip - Video > Sharpness]
        page_edit.el(L.edit.menu.edit).click()
        ...
        self.report.new_result('c70ea876-1da7-4142-86b7-93b049395471', True if default_value == '0' else False)
        self.report.start_uuid('652101c7-9180-4c3b-a06f-0cff7e24733e')
        self.report.start_uuid('399debae-ee58-4c7a-a994-bdce3d0228ed')
        pic_base = page_edit.get_preview_pic()
        page_edit.el(L.edit.sharpness.sharpness_level).set_text('100')
        time.sleep(1)
        pic_after = page_edit.get_preview_pic()
        ...
        self.report.new_result('399debae-ee58-4c7a-a994-bdce3d0228ed', result, 'DRA197426-0020')
    ...
    def test_sce_02_03_03(self):
        ...
        self.report.new_result('22625080-9f16-4ba3-9bc7-6d6cbd5ee1c1', True if amount == 20 else False)
        # >> check preview frame
    ...
    def test_sce_02_03_05(self):
        ...
        time.sleep(2)
        elm = page_edit.timeline_get_item_by_index_on_track(2, 1, 'title')
