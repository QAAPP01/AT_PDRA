...
class Test_SFT_Scenario_06_11:
    ...
    def test_sce_06_11_01(self):
        ...
        self.report.new_result('40284e7a-ee36-4196-bffa-6ae53e7fdd77', result)
        ...
        time.sleep(5)
        result = False if page_media.is_exist(L.import_media.gettyimages_premium.library_unit_purchasable) else True
        self.report.new_result('e46a1772-a2b6-4d9e-847a-5cfba36028eb', result)
        ...
        self.report.new_result('d58de69f-ebb6-432e-8703-941622a3af70', result)
    ...
    def test_sce_06_11_02(self):
        ...
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        time.sleep(3)
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.best_match)
        time.sleep(3)
        page_media.back()
        time.sleep(3)
        pic_after = page_media.get_library_pic()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.random)
        time.sleep(3)
        page_media.back()
        time.sleep(3)
        pic_after = page_media.get_library_pic()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.most_popular)
        time.sleep(3)
        page_media.back()
        time.sleep(3)
        pic_after = page_media.get_library_pic()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.subscribed)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.pay)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.by_vertical)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.by_horizontal)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.by_all)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.by_square)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
        ...
        page_media.click(L.import_media.library_gridview.btn_stock_filter)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.by_panoramic)
        time.sleep(3)
        page_media.click(L.import_media.video_library.sort_menu.newest)
        time.sleep(3)
        page_media.back()
