...
test_case_folder_name = 'TemplateScan'
...
package_version = '10.1.0'              # Please update build version info manually if didn't use auto download
package_build_number = '114516'         # Please update build version info manually if didn't use auto download

# auto download paramenters
sr_number = 'DRA220314-01'             # Please update build version info manually if didn't use auto download
auto_download = False
#auto_download = True
tr_number = 'TR220421-034'
previous_tr_number = 'TR220421-034'              # Please update build version info manually
